...
namespace Clayxels{
	...
	public class ClayxelInspector : Editor{
		...
		public override void OnInspectorGUI(){
			...
			EditorGUILayout.LabelField("Clayxels V1.8.3");
			...
			if(clayContainer.isFrozen()){
				if(clayContainer.isFrozenToMesh()){
					...
					if(GUILayout.Button((new GUIContent("generate UV map", "")))){
						...
						if(GUILayout.Button((new GUIContent("retopo", "will try to improve the mesh topology automatically")))){
							...
							if(mesh != null){
								...
								MeshUtils.smoothNormals(mesh, clayContainer.getSmoothMeshNormalAngle(), clayContainer.gameObject);
