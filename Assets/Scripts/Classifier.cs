...
public class Classifier : MonoBehaviour
{
 ...
 //   class MotonoClassLabels { public string[] motonoclasses; }
//    private string[] motonoclasses;
    // The ordered list of class names
    ...
    void Start()
    {
      ...
      //  motonoclasses = JsonUtility.FromJson<MotonoClassLabels>(classLabels.text).motonoclasses;
    ...
    public void OnGUI()
    {
        ...
        if (validIndex)
        {
            ...
            {
                emotion = classIndex;
               // Debug.Log("else(imagedataset)");
            }
            //Class label content and class order classIndex

        }
      //  string content = $"Predicted Class: {(validIndex ? classes[classIndex] : "Invalid index")}";
        string content = $"Predicted Class: {(validIndex ? emotion : "Invalid index")}";
      //  if (printDebugMessages) Debug.Log(validIndex ? $"FaceEmotion: {emotion}" : "Invalid index");
